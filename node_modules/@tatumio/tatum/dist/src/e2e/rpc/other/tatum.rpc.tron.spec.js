...
const getTronRpc = async (testnet) => await service_1.TatumSDK.init(e2e_util_1.e2eUtil.initConfig(testnet ? service_1.Network.TRON_SHASTA : service_1.Network.TRON, testnet ? process.env.V3_API_KEY_TESTNET : process.env.V4_API_KEY_MAINNET));
describe('RPCs', () => {
    describe('TRON', () => {
        describe('testnet', () => {
